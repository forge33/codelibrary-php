...
/**
 * RatePlanCharge Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RatePlanCharge implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'RatePlanCharge';
    ...
    protected static $swaggerTypes = [
        ...
        'uom' => 'string',
        'unused_units_credit_rates' => 'double',
        'up_to_periods' => 'int',
    ...
    protected static $setters = [
        ...
        'rollover_balance' => 'setRolloverBalance',
        'segment' => 'setSegment',
    ...
    protected static $getters = [
        ...
        'rollover_balance' => 'getRolloverBalance',
        'segment' => 'getSegment',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rollover_balance'] = isset($data['rollover_balance']) ? $data['rollover_balance'] : null;
     ...
     * @param double $discount_percentage Query Filter
     * @return $this
     */
    ...
    /**
     * Sets included_units
     * @param double $included_units Query Filter
     * @return $this
     */
    ...
    /**
     * Sets overage_price
     * @param double $overage_price Query Filter
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param double $price Query Filter
     * @return $this
     */
     ...
     * @param string $product_rate_plan_charge_id The ID of the product rate plan charge associated with the subscription rate plan charge, **Character limit**: 32 **Values**: inherited from `ProductRatePlanCharge.Id`
     * @return $this
     */
     ...
     * @param double $unused_units_credit_rates Specifies the rate to credit a customer for unused units of usage. This field is applicable only for overage charge models when the `OverageUnusedUnitsCreditOption` field value is CreditBySpecificRate. **Character limit**: 16 **Values**: a valid decimal value
     * @return $this
     */
     ...
     * @param string $usage_record_rating_option Determines how Zuora processes usage records for per-unit usage charges. **Character limit**: 18 **Values**: automatically generated
     * @return $this
     */
     ...
     * @param bool $use_discount_specific_accounting_code Determines whether to define a new accounting code for the new discount charge. **Character limit**: 5 **Values**: inherited from `ProductRatePlanCharge.UseDiscountSpecificAccountingCode`
     * @return $this
     */
