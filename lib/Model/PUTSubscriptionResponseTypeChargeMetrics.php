...
/**
 * PUTSubscriptionResponseTypeChargeMetrics Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTSubscriptionResponseTypeChargeMetrics implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUTSubscriptionResponseType_chargeMetrics';
    ...
    /**
     * Sets dmrr
     * @param string $dmrr Change in total contract value.
     * @return $this
     */
    ...
    /**
     * Sets dtcv
     * @param string $dtcv Change in monthly recurring revenue.
     * @return $this
     */
