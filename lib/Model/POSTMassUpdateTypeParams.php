...
/**
 * POSTMassUpdateTypeParams Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTMassUpdateTypeParams implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTMassUpdateType_params';
    ...
    /**
     * Sets checksum
     * @param string $checksum An MD5 checksum that is used to validate the integrity of the uploaded file. The checksum is a 32-character string.
     * @return $this
     */
