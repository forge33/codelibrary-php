...
/**
 * GETUsageType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETUsageType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETUsageType';
    ...
    /**
     * Sets charge_number
     * @param string $charge_number Number of the rate-plan charge that pays for this usage.
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id Unique ID for the usage item.
     * @return $this
     */
    ...
    /**
     * Sets quantity
     * @param string $quantity Number of units used.
     * @return $this
     */
    ...
    /**
     * Sets source_name
     * @param string $source_name Source of the usage data. Possible values are: `Import`, `API`.
     * @return $this
     */
     ...
     * @param \DateTime $start_date_time Start date of the time period in which usage is tracked. Zuora uses this field value to determine the usage date.
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status Possible values are: `Importing`, `Pending`, `Processed`.
     * @return $this
     */
     ...
     * @param \DateTime $submission_date_time Date when usage was submitted.
     * @return $this
     */
     ...
     * @param string $subscription_number Number of the subscription covering this usage.
     * @return $this
     */
     ...
     * @param string $unit_of_measure Unit used to measure consumption, as configured in the web-based UI at **Z-Billing > Settings**.
     * @return $this
     */
