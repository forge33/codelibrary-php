...
/**
 * PUTSrpUpdateType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTSrpUpdateType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUTSrpUpdateType';
    ...
    protected static $swaggerTypes = [
        'charge_update_details' => '\Swagger\Client\Model\PUTScUpdateType[]',
    ...
    protected static $setters = [
        'charge_update_details' => 'setChargeUpdateDetails',
    ...
    protected static $getters = [
        'charge_update_details' => 'getChargeUpdateDetails',
    ...
    {
        $this->container['charge_update_details'] = isset($data['charge_update_details']) ? $data['charge_update_details'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rate_plan_id'] === null) {
            $invalid_properties[] = "'rate_plan_id' can't be null";
        }
    ...
    /**
     * Gets charge_update_details
     * @return \Swagger\Client\Model\PUTScUpdateType[]
     */
    public function getChargeUpdateDetails()
    {
        return $this->container['charge_update_details'];
    }

    /**
     * Sets charge_update_details
     * @param \Swagger\Client\Model\PUTScUpdateType[] $charge_update_details Container for one or more product rate plan charges.
     * @return $this
     */
    public function setChargeUpdateDetails($charge_update_details)
    {
        $this->container['charge_update_details'] = $charge_update_details;
    ...
    /**
     * Sets rate_plan_id
     * @param string $rate_plan_id ID of a rate plan for this subscription.
     * @return $this
     */
     ...
     * @param \DateTime $service_activation_date The date when the update amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate
     * @return $this
     */
