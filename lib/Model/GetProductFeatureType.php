...
/**
 * GetProductFeatureType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetProductFeatureType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GetProductFeatureType';
    ...
    /**
     * Sets code
     * @param string $code Feature code, up to 255 characters long.
     * @return $this
     */
