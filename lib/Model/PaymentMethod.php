...
class PaymentMethod implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'first_name' => 'string',
        'gateway_option_data' => '\Swagger\Client\Model\GatewayOptionData',
        'iban' => 'string',
        'ip_address' => 'string',
        'id' => 'string',
    ...
    protected static $setters = [
        ...
        'ach_account_number' => 'setAchAccountNumber',
        ...
        'credit_card_security_code' => 'setCreditCardSecurityCode',
        ...
        'gateway_option_data' => 'setGatewayOptionData',
        'iban' => 'setIban',
    ...
    protected static $getters = [
        ...
        'ach_account_number' => 'getAchAccountNumber',
        ...
        'credit_card_security_code' => 'getCreditCardSecurityCode',
        ...
        'gateway_option_data' => 'getGatewayOptionData',
        'iban' => 'getIban',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ach_account_number'] = isset($data['ach_account_number']) ? $data['ach_account_number'] : null;
        ...
        $this->container['credit_card_security_code'] = isset($data['credit_card_security_code']) ? $data['credit_card_security_code'] : null;
        ...
        $this->container['gateway_option_data'] = isset($data['gateway_option_data']) ? $data['gateway_option_data'] : null;
    ...
    /**
     * Gets ach_account_number
     * @return string
     */
    public function getAchAccountNumber()
    {
        return $this->container['ach_account_number'];
    }

    /**
     * Sets ach_account_number
     * @param string $ach_account_number The bank account number associated with the ACH payment. Use this field for ACH payment methods. **Character limit**: 30 **Values**: a string of 30 numeric characters or fewer
     * @return $this
     */
    public function setAchAccountNumber($ach_account_number)
    {
        $this->container['ach_account_number'] = $ach_account_number;
     ...
     * @param string $ach_account_number_mask This is a masked displayable version of the ACH account number, used for security purposes. For example: `XXXXXXXXX54321`. Use this field for ACH payment methods. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets active
     * @param bool $active Specifies whether a payment method is available in Zuora. The default value is `false`. **Character limit**: 5 **Values**: `true`, `false`
     * @return $this
     */
     ...
     * @param string $bank_identification_number The first six digits of the payment method's number, such as the credit card number or account number. Banks use this number to identify a payment method. **Character limit**: 6 **Values**:  string of 6 characters or fewer
     * @return $this
     */
     ...
     * @param string $bank_transfer_account_number The number of the customer's bank account. Use this field for direct debit payment methods. **Character limit**:30 **Values**:  string of 30 characters or fewer
     * @return $this
     */
     ...
     * @param string $bank_transfer_account_number_mask This is a masked displayable version of the ACH account number, used for security purposes. For example: `XXXXXXXXX54321`. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets created_date
     * @param \DateTime $created_date The date when the `PaymentMethod` object was created in the Zuora system. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
     ...
     * @param string $credit_card_mask_number A masked version of the credit or debit card number. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
     ...
     * @param string $credit_card_number The credit card or debit card number. This is an insert-only field; it cannot be updated nor queried for security purposes. This field is required only when you define a debit card or credit card payment. **Character limit**: 16 **Values**: a string of 16 characters or fewer
     * @return $this
     */
    ...
    /**
     * Gets credit_card_security_code
     * @return string
     */
    public function getCreditCardSecurityCode()
    {
        return $this->container['credit_card_security_code'];
    }

    /**
     * Sets credit_card_security_code
     * @param string $credit_card_security_code The CVV or CVV2 security code. See [How do I control what information Zuora sends over to the Payment Gateway?](https://knowledgecenter.zuora.com/kb/How_do_I_control_information_sent_to_payment_gateways_when_verifying_payment_methods%3F) for more information. To ensure PCI compliance, this value is not stored and cannot be queried. **Character limit**: **Values**: a valid CVV or CVV2 security code
     * @return $this
     */
    public function setCreditCardSecurityCode($credit_card_security_code)
    {
        $this->container['credit_card_security_code'] = $credit_card_security_code;
    ...
    /**
     * Gets gateway_option_data
     * @return \Swagger\Client\Model\GatewayOptionData
     */
    public function getGatewayOptionData()
    {
        return $this->container['gateway_option_data'];
    }

    /**
     * Sets gateway_option_data
     * @param \Swagger\Client\Model\GatewayOptionData $gateway_option_data Use this field to pass gateway options. **Character limit**: 255 **Values**: [GatewayOption](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Payment/Pass_Gateway_Parameters)
     * @return $this
     */
    public function setGatewayOptionData($gateway_option_data)
    {
        $this->container['gateway_option_data'] = $gateway_option_data;
    ...
    /**
     * Sets id
     * @param string $id The ID of this object. Upon creation, the ID of this object is `PaymentMethodId`. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
     ...
     * @param \DateTime $last_failed_sale_transaction_date The date of the last failed attempt to collect payment with this payment method. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Create Query Delete Filter
     * @return $this
     */
     ...
     * @param int $num_consecutive_failures The number of consecutive failed payment for this payment method. It is reset to 0 upon successful payment. You can use the API to update the field value to 0. **Character limit**: **Values**: a positive whole number
     * @return $this
     */
     ...
     * @param bool $skip_validation Creates the payment method even if authorization fails with the payment gateway. **Character limit**: 5 **Values**: `t``rue`, `false`
     * @return $this
     */
    ...
    /**
     * Sets updated_by_id
     * @param string $updated_by_id The ID of the user who last updated the payment method. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets updated_date
     * @param \DateTime $updated_date The date when the payment method was last updated. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
