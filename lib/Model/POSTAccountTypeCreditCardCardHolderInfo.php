...
/**
 * POSTAccountTypeCreditCardCardHolderInfo Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTAccountTypeCreditCardCardHolderInfo implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTAccountType_creditCard_cardHolderInfo';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['card_holder_name'] === null) {
            $invalid_properties[] = "'card_holder_name' can't be null";
        }
     ...
     * @param string $card_holder_name The card holder's full name as it appears on the card, e.g., \"John J Smith\", 50 characters or less.
     * @return $this
     */
    ...
    /**
     * Sets country
     * @param string $country Country; must be a [valid country name or abbreviation](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/A_Country_Names_and_Their_ISO_Codes).
     * @return $this
     */
    ...
    /**
     * Sets state
     * @param string $state State; must be a [valid state name or 2-character abbreviation](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/B_State_Names_and_2-Digit_Codes).
     * @return $this
     */
