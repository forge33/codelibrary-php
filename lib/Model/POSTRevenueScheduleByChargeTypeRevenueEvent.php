...
/**
 * POSTRevenueScheduleByChargeTypeRevenueEvent Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTRevenueScheduleByChargeTypeRevenueEvent implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTRevenueScheduleByChargeType_revenueEvent';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['event_type_system_id'] === null) {
            $invalid_properties[] = "'event_type_system_id' can't be null";
        }
