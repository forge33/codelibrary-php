...
/**
 * ProxyCreateAccount Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyCreateAccount implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyCreateAccount';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bcd_setting_option'] === null) {
            $invalid_properties[] = "'bcd_setting_option' can't be null";
        }
        ...
        if ($this->container['credit_balance'] === null) {
            $invalid_properties[] = "'credit_balance' can't be null";
        }
        ...
        if ($this->container['total_invoice_balance'] === null) {
            $invalid_properties[] = "'total_invoice_balance' can't be null";
        }
