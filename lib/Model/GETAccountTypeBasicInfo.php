...
/**
 * GETAccountTypeBasicInfo Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountTypeBasicInfo implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountType_basicInfo';
     ...
     * @param string $communication_profile_id ID of a [communication profile](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Communication_Profile).
     * @return $this
     */
    ...
    /**
     * Sets crm_id
     * @param string $crm_id CRM account ID for the account, 100 characters or less.
     * @return $this
     */
    ...
    /**
     * Sets notes
     * @param string $notes Notes associated with the account, up to 65,535 characters.
     * @return $this
     */
