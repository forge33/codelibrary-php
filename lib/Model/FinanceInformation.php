...
/**
 * FinanceInformation Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FinanceInformation implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'financeInformation';
     ...
     * @param string $deferred_revenue_accounting_code The accounting code for deferred revenue, such as Monthly Recurring Liability.
     * @return $this
     */
     ...
     * @param string $deferred_revenue_accounting_code_type The type associated with the deferred revenue accounting code, such as Deferred Revenue.
     * @return $this
     */
     ...
     * @param string $recognized_revenue_accounting_code The accounting code for recognized revenue, such as Monthly Recurring Charges or Overage Charges.
     * @return $this
     */
     ...
     * @param string $recognized_revenue_accounting_code_type The type associated with the recognized revenue accounting code, such as Sales Revenue or Sales Discount.
     * @return $this
     */
