...
/**
 * InvoiceProcessingOptions Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InvoiceProcessingOptions implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceProcessingOptions';
     ...
     * @param \DateTime $invoice_target_date The date that determines which charges to bill. Charges prior to this date or on this date are billed on the resulting invoices.
     * @return $this
     */
