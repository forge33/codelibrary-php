...
/**
 * POSTScCreateType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTScCreateType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTScCreateType';
     ...
     * @param string $apply_discount_to Specifies the type of charges that you want a specific discount to apply to.  Values:  * `ONETIME` * `RECURRING` * `USAGE` * `ONETIMERECURRING` * `ONETIMEUSAGE` * `RECURRINGUSAGE` * `ONETIMERECURRINGUSAGE`
     * @return $this
     */
    ...
    /**
     * Sets bill_cycle_day
     * @param string $bill_cycle_day Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month the customer is billed.  Values: `1`-`31`
     * @return $this
     */
    ...
    /**
     * Sets billing_period
     * @param string $billing_period Billing period for the charge. The start day of the billing period is also called the bill cycle day (BCD).  Values:  * `Month` * `Quarter` * `Semi_Annual` * `Annual` * `Eighteen_Months` * `Two_Years` * `Three_Years` * `Five_Years` * `Specific_Months` * `Subscription_Term` * `Week` * `Specific_Weeks`
     * @return $this
     */
     ...
     * @param string $billing_period_alignment Aligns charges within the same subscription if multiple charges begin on different dates.  Values:  * `AlignToCharge` * `AlignToSubscriptionStart` * `AlignToTermStart`
     * @return $this
     */
     ...
     * @param string $discount_amount Specifies the amount of fixed-amount discount.
     * @return $this
     */
    ...
    /**
     * Sets discount_level
     * @param string $discount_level Specifies if the discount applies to the product rate plan only, the entire subscription, or to any activity in the account.  Values:  * `rateplan` * `subscription` * `account`
     * @return $this
     */
     ...
     * @param string $discount_percentage Percentage of discount for a percentage discount.
     * @return $this
     */
    ...
    /**
     * Sets included_units
     * @param string $included_units Specifies the number of units in the base set of units for this charge. Must be >=`0`.
     * @return $this
     */
     ...
     * @param string $list_price_base The list price base for the product rate plan charge.  Values:  * `Per_Billing_Period` * `Per_Month` * `Per_Week`
     * @return $this
     */
    ...
    /**
     * Sets number
     * @param string $number Unique number that identifies the charge. Max 50 characters. System-generated if not provided.
     * @return $this
     */
    ...
    /**
     * Sets overage_price
     * @param string $overage_price Price for units over the allowed amount.
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param string $price Price for units in the subscription rate plan.
     * @return $this
     */
     ...
     * @param string $price_increase_percentage Specifies the percentage to increase or decrease the price of a termed subscription's renewal. Required if you set the `PriceChangeOption` field to `SpecificPercentageValue`.   Value must be a decimal between `-100` and `100`.
     * @return $this
     */
     ...
     * @param string $product_rate_plan_charge_id ID of a product rate-plan charge for this subscription.
     * @return $this
     */
    ...
    /**
     * Sets quantity
     * @param string $quantity Number of units. Must be a decimal >=`0`.
     * @return $this
     */
     ...
     * @param int $specific_billing_period Specifies the number of month or week for the charges billing period. Required if you set the value of the `billingPeriod` field to `Specific_Months` or `Specific_Weeks`.
     * @return $this
     */
     ...
     * @param string $unused_units_credit_rates Specifies the rate to credit a customer for unused units of usage. This field applies only for overage charge models when the `OverageUnusedUnitsCreditOption` field is set to `CreditBySpecificRate`.
     * @return $this
     */
     ...
     * @param string $weekly_bill_cycle_day Specifies which day of the week is the bill cycle day (BCD) for the charge.   Values:  * `Sunday` * `Monday` * `Tuesday` * `Wednesday` * `Thursday` * `Friday` * `Saturday`
     * @return $this
     */
