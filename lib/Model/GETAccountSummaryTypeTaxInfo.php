...
/**
 * GETAccountSummaryTypeTaxInfo Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountSummaryTypeTaxInfo implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountSummaryType_taxInfo';
    ...
    /**
     * Sets vat_id
     * @param string $vat_id EU Value Added Tax ID.
     * @return $this
     */
    ...
    /**
     * Sets company_code
     * @param string $company_code Unique code that identifies a company account in Avalara.
     * @return $this
     */
     ...
     * @param string $exempt_certificate_id ID of the customer tax exemption certificate.
     * @return $this
     */
     ...
     * @param string $exempt_certificate_type Type of tax exemption certificate that the customer holds.
     * @return $this
     */
     ...
     * @param string $exempt_description Description of the tax exemption certificate that the customer holds.
     * @return $this
     */
     ...
     * @param \DateTime $exempt_effective_date Date when the customer tax exemption starts.
     * @return $this
     */
     ...
     * @param \DateTime $exempt_expiration_date Date when the customer tax exemption expires.
     * @return $this
     */
    ...
    /**
     * Sets exempt_status
     * @param string $exempt_status Status of the account tax exemption.
     * @return $this
     */
