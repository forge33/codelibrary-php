...
/**
 * POSTJournalEntryType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTJournalEntryType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTJournalEntryType';
    ...
    protected static $swaggerTypes = [
        ...
        'journal_entry_items' => '\Swagger\Client\Model\POSTJournalEntryItemType[]',
        'notes' => 'string',
        'segments' => '\Swagger\Client\Model\POSTJournalEntrySegmentType[]',
    ...
    {
        $invalid_properties = [];
        if ($this->container['accounting_period_name'] === null) {
            $invalid_properties[] = "'accounting_period_name' can't be null";
        }
        ...
        if ($this->container['journal_entry_items'] === null) {
            $invalid_properties[] = "'journal_entry_items' can't be null";
        }
    ...
    /**
     * Sets currency
     * @param string $currency The type of currency used.   Currency must be active in **Z-Billing Settings > Customize Currencies.**
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\POSTJournalEntryItemType[]
     */
     ...
     * @param \Swagger\Client\Model\POSTJournalEntryItemType[] $journal_entry_items Key name that represents the list of journal entry items.
     * @return $this
     */
    ...
    /**
     * Sets notes
     * @param string $notes The number associated with the revenue event.  Character limit: 2,000
     * @return $this
     */
    ...
    /**
     * Gets segments
     * @return \Swagger\Client\Model\POSTJournalEntrySegmentType[]
     */
    ...
    /**
     * Sets segments
     * @param \Swagger\Client\Model\POSTJournalEntrySegmentType[] $segments List of segments that apply to the summary journal entry.
     * @return $this
     */
