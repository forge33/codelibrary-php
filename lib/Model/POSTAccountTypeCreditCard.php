...
/**
 * POSTAccountTypeCreditCard Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTAccountTypeCreditCard implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTAccountType_creditCard';
    ...
    protected static $swaggerTypes = [
        'card_holder_info' => '\Swagger\Client\Model\POSTAccountTypeCreditCardCardHolderInfo',
        'card_number' => 'string',
        'card_type' => 'string',
     ...
     * @return \Swagger\Client\Model\POSTAccountTypeCreditCardCardHolderInfo
     */
     ...
     * @param \Swagger\Client\Model\POSTAccountTypeCreditCardCardHolderInfo $card_holder_info
     * @return $this
     */
    ...
    /**
     * Sets card_number
     * @param string $card_number Card number, up to 16 characters. Once created, this field can't be updated or queried, and is only available in masked format (e.g., XXXX-XXXX-XXXX-1234).
     * @return $this
     */
    ...
    /**
     * Sets card_type
     * @param string $card_type Possible values are: `Visa`, `MasterCard`, `AmericanExpress`, `Discover`.
     * @return $this
     */
