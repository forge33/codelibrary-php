...
/**
 * POSTJournalRunType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTJournalRunType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTJournalRunType';
    ...
    protected static $swaggerTypes = [
        ...
        'transaction_types' => '\Swagger\Client\Model\POSTJournalRunTransactionType[]'
    ];
    ...
    {
        $invalid_properties = [];
        if ($this->container['journal_entry_date'] === null) {
            $invalid_properties[] = "'journal_entry_date' can't be null";
        }
        if ($this->container['transaction_types'] === null) {
            $invalid_properties[] = "'transaction_types' can't be null";
        }
     ...
     * @param string $accounting_period_name Name of the accounting period.  This field determines the target start and end dates of the journal run.  Required if you don't include 'targetStartDate' and 'targetEndDate'.
     * @return $this
     */
     ...
     * @param \DateTime $target_end_date The target end date of the journal run.  If you include 'accountingPeriodName', the 'targetEndDate' must be empty or the same as the end date of the accounting period specified in 'accountingPeriodName'.
     * @return $this
     */
     ...
     * @param \DateTime $target_start_date The target start date of the journal run.  Required if you include targetEndDate.  If you include 'accountingPeriodName', the 'targetStartDate' must be empty or the same as the start date of the accounting period specified in 'accountingPeriodName'.
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\POSTJournalRunTransactionType[]
     */
     ...
     * @param \Swagger\Client\Model\POSTJournalRunTransactionType[] $transaction_types Transaction types included in the journal run.  You can include one or more transaction types.
     * @return $this
     */
