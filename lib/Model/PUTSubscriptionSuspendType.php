...
/**
 * PUTSubscriptionSuspendType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTSubscriptionSuspendType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUTSubscriptionSuspendType';
    ...
    protected static $swaggerTypes = [
        ...
        'suspend_periods' => 'string',
        'suspend_periods_type' => 'string',
        'suspend_policy' => 'string',
        'suspend_specific_date' => '\DateTime'
    ];
    ...
    protected static $setters = [
        ...
        'suspend_periods' => 'setSuspendPeriods',
        'suspend_periods_type' => 'setSuspendPeriodsType',
        'suspend_policy' => 'setSuspendPolicy',
        'suspend_specific_date' => 'setSuspendSpecificDate'
    ];
    ...
    protected static $getters = [
        ...
        'suspend_periods' => 'getSuspendPeriods',
        'suspend_periods_type' => 'getSuspendPeriodsType',
        'suspend_policy' => 'getSuspendPolicy',
        'suspend_specific_date' => 'getSuspendSpecificDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['suspend_periods'] = isset($data['suspend_periods']) ? $data['suspend_periods'] : null;
        $this->container['suspend_periods_type'] = isset($data['suspend_periods_type']) ? $data['suspend_periods_type'] : null;
        $this->container['suspend_policy'] = isset($data['suspend_policy']) ? $data['suspend_policy'] : null;
        $this->container['suspend_specific_date'] = isset($data['suspend_specific_date']) ? $data['suspend_specific_date'] : null;
    }
    ...
    {
        $invalid_properties = [];
        if ($this->container['suspend_policy'] === null) {
            $invalid_properties[] = "'suspend_policy' can't be null";
        }
    ...
    /**
     * Sets collect
     * @param bool $collect Collects an automatic payment for a subscription. The collection generated in this operation is only for this subscription, not for the entire customer account.  If the value is `true`, the automatic payment is collected. If the value is `false`, no action is taken.  The default value is `false`.  Prerequisite: `invoice` must be `true`.   **Note:** This field is in Zuora REST API version control. Supported minor versions are 196.0 or later. To use this field in the method, you must set the `zuora-version` field to the minor version number in the request header. See [Zuora REST API Versions](https://knowledgecenter.zuora.com/DC_Developers/REST_API/A_REST_basics#Zuora_REST_API_Versions) for more information.
     * @return $this
     */
     ...
     * @param \DateTime $contract_effective_date The date when the customer notifies you that they want to amend their subscription.
     * @return $this
     */
    ...
    /**
     * Sets resume
     * @param bool $resume Whether to set when to resume a subscription when creating a suspend amendment. Values: `true`, `false`.
     * @return $this
     */
    ...
    /**
     * Gets suspend_periods
     * @return string
     */
    public function getSuspendPeriods()
    {
        return $this->container['suspend_periods'];
    }

    /**
     * Sets suspend_periods
     * @param string $suspend_periods The length of the period used to specify when the subscription suspension takes effect. The subscription suspension takes effect after a specified period based on today's date. You must use this field together with the `suspendPeriodsType` field to specify the period.  **Note:** This field is only applicable only when the suspendPolicy field is set to FixedPeriodsFromToday.
     * @return $this
     */
    public function setSuspendPeriods($suspend_periods)
    {
        $this->container['suspend_periods'] = $suspend_periods;

        return $this;
    }

    /**
     * Gets suspend_periods_type
     * @return string
     */
    public function getSuspendPeriodsType()
    {
        return $this->container['suspend_periods_type'];
    }

    /**
     * Sets suspend_periods_type
     * @param string $suspend_periods_type The period type used to define when the subscription suspension takes effect. The subscription suspension takes effect after a specified period based on today's date. You must use this field together with the suspendPeriods field to specify the period.  Type: string (enum)  Values: `Day`, `Week`, `Month`, `Year`  **Note:** This field is only applicable only when the suspendPolicy field is set to FixedPeriodsFromToday.
     * @return $this
     */
    public function setSuspendPeriodsType($suspend_periods_type)
    {
        $this->container['suspend_periods_type'] = $suspend_periods_type;
