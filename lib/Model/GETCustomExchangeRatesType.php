...
/**
 * GETCustomExchangeRatesType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETCustomExchangeRatesType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETCustomExchangeRatesType';
    ...
    protected static $swaggerTypes = [
        'inverse' => 'bool',
        'rates' => '\Swagger\Client\Model\GETCustomExchangeRatesDataType[]',
        'success' => 'bool'
    ];
    ...
    /**
     * Gets rates
     * @return \Swagger\Client\Model\GETCustomExchangeRatesDataType[]
     */
    ...
    /**
     * Sets rates
     * @param \Swagger\Client\Model\GETCustomExchangeRatesDataType[] $rates Container for exchange rate data. Contains a set of fields that provide exchange rate data for each day between the specified `startDate` and `endDate` (inclusive).
     * @return $this
     */
