...
/**
 * POSTAccountingPeriodType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTAccountingPeriodType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTAccountingPeriodType';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fiscal_year'] === null) {
            $invalid_properties[] = "'fiscal_year' can't be null";
        }
    ...
    /**
     * Sets end_date
     * @param \DateTime $end_date The end date of the accounting period in yyyy-mm-dd format, for example, \"2016-02-19\".
     * @return $this
     */
    ...
    /**
     * Sets fiscal_year
     * @param string $fiscal_year Fiscal year of the accounting period in yyyy format, for example, \"2016\".
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Name of the accounting period.  Accounting period name must be unique. Maximum of 100 characters.
     * @return $this
     */
    ...
    /**
     * Sets notes
     * @param string $notes Notes about the accounting period.  Maximum of 255 characters.
     * @return $this
     */
    ...
    /**
     * Sets start_date
     * @param \DateTime $start_date The start date of the accounting period in yyyy-mm-dd format, for example, \"2016-02-19\".
     * @return $this
     */
