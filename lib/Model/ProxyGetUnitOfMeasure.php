...
/**
 * ProxyGetUnitOfMeasure Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyGetUnitOfMeasure implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyGetUnitOfMeasure';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rounding_mode'] = isset($data['rounding_mode']) ? $data['rounding_mode'] : null;
    ...
    /**
     * Sets active
     * @param bool $active Indicates if the UOM is available for new product rate plans. The default value is `true`. **Character limit**: 5 **Values**: `true`, `false `
     * @return $this
     */
    ...
    /**
     * Sets created_by_id
     * @param string $created_by_id The ID of the Zuora user who created the UOM. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets created_date
     * @param \DateTime $created_date The date when the UOM was created. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets decimal_places
     * @param int $decimal_places The number of digits to the right of the decimal point that you want to measure for the unit. To use whole numbers only, set this value to 0. You can't change this value after this `UOM` is used in any product, subscription, or usage. **Character limit**: 1 **Values**: an integer between 0 and 9, exclusive
     * @return $this
     */
    ...
    /**
     * Sets displayed_as
     * @param string $displayed_as The name of the UOM that you want displayed on invoices. The default value is the `UomName` field value. **Character limit**: 50 **Values**: A string of 50 characters or fewer
     * @return $this
     */
    ...
    /**
     * Sets rounding_mode
     * @param string $rounding_mode Specifies whether to round the UOM value up or down when the value exceeds the `DecimalPlaces` field value. The default value is `Up`. **Character limit**: 4 **Values**: `Up`, `Down`
     * @return $this
     */
    ...
    /**
     * Sets updated_by_id
     * @param string $updated_by_id The ID of the user who lasted updated the UOM. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets updated_date
     * @param \DateTime $updated_date The date when the UOM was last updated. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
