...
/**
 * ProxyCreateImport Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyCreateImport implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyCreateImport';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['import_type'] === null) {
            $invalid_properties[] = "'import_type' can't be null";
        }
        if ($this->container['imported_count'] === null) {
            $invalid_properties[] = "'imported_count' can't be null";
        }
        if ($this->container['original_resource_url'] === null) {
            $invalid_properties[] = "'original_resource_url' can't be null";
        }
        if ($this->container['result_resource_url'] === null) {
            $invalid_properties[] = "'result_resource_url' can't be null";
        }
