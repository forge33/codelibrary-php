...
/**
 * GETInvoicesInvoiceItemType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETInvoicesInvoiceItemType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETInvoicesInvoiceItemType';
    ...
    /**
     * Sets charge_amount
     * @param string $charge_amount The amount of the charge. This amount doesn't include taxes regardless if the charge's tax mode is inclusive or exclusive.
     * @return $this
     */
    ...
    /**
     * Sets quantity
     * @param string $quantity Quantity of this item, in the configured unit of measure for the charge.
     * @return $this
     */
     ...
     * @param \DateTime $service_end_date End date of the service period for this item, i.e., the last day of the service period, as _yyyy-mm-dd_.
     * @return $this
     */
     ...
     * @param \DateTime $service_start_date Start date of the service period for this item, as _yyyy-mm-dd_. For a one-time fee item, the date of the charge.
     * @return $this
     */
     ...
     * @param string $subscription_id ID of the subscription for this item.
     * @return $this
     */
     ...
     * @param string $subscription_name Name of the subscription for this item.
     * @return $this
     */
    ...
    /**
     * Sets tax_amount
     * @param string $tax_amount Tax applied to the charge.
     * @return $this
     */
