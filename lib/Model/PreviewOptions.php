...
/**
 * PreviewOptions Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
...
class PreviewOptions implements ArrayAccess
{
    ...
    {
        $this->container['enable_preview_mode'] = isset($data['enable_preview_mode']) ? $data['enable_preview_mode'] : null;
        ...
        $this->container['preview_through_term_end'] = isset($data['preview_through_term_end']) ? $data['preview_through_term_end'] : null;
    ...
    /**
     * Gets enable_preview_mode
     * @return bool
     */
    public function getEnablePreviewMode()
    {
        return $this->container['enable_preview_mode'];
    }

    /**
     * Sets enable_preview_mode
     * @param bool $enable_preview_mode 
     * @return $this
     */
    public function setEnablePreviewMode($enable_preview_mode)
    {
        $this->container['enable_preview_mode'] = $enable_preview_mode;
     ...
     * @param bool $include_existing_draft_invoice_items 
     * @return $this
     */
    ...
    /**
     * Gets preview_through_term_end
     * @return bool
     */
    public function getPreviewThroughTermEnd()
    {
        return $this->container['preview_through_term_end'];
    }

    /**
     * Sets preview_through_term_end
     * @param bool $preview_through_term_end 
     * @return $this
     */
    public function setPreviewThroughTermEnd($preview_through_term_end)
    {
        $this->container['preview_through_term_end'] = $preview_through_term_end;
