...
/**
 * POSTJournalEntrySegmentType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTJournalEntrySegmentType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTJournalEntrySegmentType';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['segment_value'] === null) {
            $invalid_properties[] = "'segment_value' can't be null";
        }
    ...
    /**
     * Sets segment_name
     * @param string $segment_name Name of segment.
     * @return $this
     */
    ...
    /**
     * Sets segment_value
     * @param string $segment_value Value of segment in this summary journal entry.
     * @return $this
     */
