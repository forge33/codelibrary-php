...
/**
 * GETProductType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETProductType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETProductType';
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'string',
        'name' => 'string',
        'product_features' => '\Swagger\Client\Model\GetProductFeatureType[]',
        'product_rate_plans' => '\Swagger\Client\Model\GETProductRatePlanType[]',
        'sku' => 'string',
        'tags' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'product_rate_plans' => 'setProductRatePlans',
        'sku' => 'setSku',
        'tags' => 'setTags'
    ];
    ...
    protected static $getters = [
        ...
        'product_rate_plans' => 'getProductRatePlans',
        'sku' => 'getSku',
        'tags' => 'getTags'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['product_features'] = isset($data['product_features']) ? $data['product_features'] : null;
        $this->container['product_rate_plans'] = isset($data['product_rate_plans']) ? $data['product_rate_plans'] : null;
    ...
    /**
     * Sets category
     * @param string $category Category of the product. Used by Zuora Quotes Guided Product Selector.  Possible values are:   - Base Products   - Add On Services   - Miscellaneous Products
     * @return $this
     */
     ...
     * @param \DateTime $effective_end_date The date when the product expires and cannot be subscribed to anymore, as `yyyy-mm-dd`.
     * @return $this
     */
     ...
     * @param \DateTime $effective_start_date The date when the product becomes available and can be subscribed to, as `yyyy-mm-dd`.
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Product name, up to 100 characters.
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\GetProductFeatureType[]
     */
    ...
    /**
     * Gets product_rate_plans
     * @return \Swagger\Client\Model\GETProductRatePlanType[]
     */
    public function getProductRatePlans()
    {
        return $this->container['product_rate_plans'];
    }

    /**
     * Sets product_rate_plans
     * @param \Swagger\Client\Model\GETProductRatePlanType[] $product_rate_plans Container for one or more product rate plans:
     * @return $this
     */
    public function setProductRatePlans($product_rate_plans)
    {
        $this->container['product_rate_plans'] = $product_rate_plans;
    ...
    /**
     * Sets sku
     * @param string $sku Unique product SKU, up to 50 characters.
     * @return $this
     */
