...
/**
 * GETAccountSummaryTypeBasicInfoDefaultPaymentMethod Class Doc Comment
 *
 * @category    Class */
 // @description dummy
/**
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountSummaryTypeBasicInfoDefaultPaymentMethod implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountSummaryType_basicInfo_defaultPaymentMethod';
     ...
     * @param string $credit_card_expiration_month Two-digit numeric card expiration month as `mm`.
     * @return $this
     */
     ...
     * @param string $credit_card_expiration_year Four-digit card expiration year as `yyyy`.
     * @return $this
     */
     ...
     * @param string $credit_card_number Credit card number, 16 characters or less, displayed in masked format (e.g., ************1234).
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id The ID of the credit card payment method associated with this account.
     * @return $this
     */
     ...
     * @param string $payment_method_type dummy
     * @return $this
     */
