 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AmendResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AmendResult';
    ...
    protected static $swaggerTypes = [
        ...
        'invoice_datas' => '\Swagger\Client\Model\InvoiceData[]',
        'invoice_id' => 'string',
        'payment_id' => 'string',
        'payment_transaction_number' => 'string',
        'subscription_id' => 'string',
        'success' => 'bool',
        'total_delta_mrr' => 'double',
        'total_delta_tcv' => 'double'
    ];
    ...
    {
        $this->container['amendment_ids'] = isset($data['amendment_ids']) ? $data['amendment_ids'] : null;
        ...
        $this->container['invoice_datas'] = isset($data['invoice_datas']) ? $data['invoice_datas'] : null;
    ...
    {
        return $this->container['amendment_ids'];
    }

    /**
     * Sets amendment_ids
     * @param string $amendment_ids The IDs of the associated Amendment object. There can be as many as three AmendmentId values.
     * @return $this
     */
    public function setAmendmentIds($amendment_ids)
    {
        $this->container['amendment_ids'] = $amendment_ids;
    ...
    {
        return $this->container['invoice_datas'];
    }

    /**
     * Sets invoice_datas
     * @param \Swagger\Client\Model\InvoiceData[] $invoice_datas 
     * @return $this
     */
    public function setInvoiceDatas($invoice_datas)
    {
        $this->container['invoice_datas'] = $invoice_datas;
