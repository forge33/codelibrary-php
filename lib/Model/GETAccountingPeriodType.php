...
/**
 * GETAccountingPeriodType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountingPeriodType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountingPeriodType';
    ...
    /**
     * Sets updated_by
     * @param string $updated_by ID of the user who last updated the accounting period.
     * @return $this
     */
