...
/**
 * GETAccountSummaryTypeBasicInfo Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountSummaryTypeBasicInfo implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountSummaryType_basicInfo';
    ...
    protected static $swaggerTypes = [
        ...
        'default_payment_method' => '\Swagger\Client\Model\GETAccountSummaryTypeBasicInfoDefaultPaymentMethod',
        'id' => 'string',
    ...
    /**
     * Sets balance
     * @param string $balance Current outstanding balance.
     * @return $this
     */
    ...
    /**
     * Sets bill_cycle_day
     * @param string $bill_cycle_day Billing cycle day (BCD), the day of the month when a bill run generates invoices for the account.
     * @return $this
     */
    ...
    /**
     * Sets currency
     * @param string $currency A currency value. See [Customize Currencies](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Customize_Currencies) for more information.
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\GETAccountSummaryTypeBasicInfoDefaultPaymentMethod
     */
     ...
     * @param \Swagger\Client\Model\GETAccountSummaryTypeBasicInfoDefaultPaymentMethod $default_payment_method
     * @return $this
     */
     ...
     * @param \DateTime $last_invoice_date Date of the most recent invoice for the account; null if no invoice has ever been generated.
     * @return $this
     */
     ...
     * @param string $last_payment_amount Amount of the most recent payment collected for the account; null if no payment has ever been collected.
     * @return $this
     */
     ...
     * @param \DateTime $last_payment_date Date of the most recent payment collected for the account. Null if no payment has ever been collected.
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status Account status; possible values are: `Active`, `Draft`, `Canceled`.
     * @return $this
     */
