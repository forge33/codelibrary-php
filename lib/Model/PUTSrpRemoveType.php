...
/**
 * PUTSrpRemoveType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTSrpRemoveType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUTSrpRemoveType';
     ...
     * @param \DateTime $contract_effective_date Effective date of the new subscription, as yyyy-mm-dd.
     * @return $this
     */
    ...
    /**
     * Sets rate_plan_id
     * @param string $rate_plan_id ID of a rate-plan charge for this subscription
     * @return $this
     */
     ...
     * @param \DateTime $service_activation_date The date when the remove amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate
     * @return $this
     */
