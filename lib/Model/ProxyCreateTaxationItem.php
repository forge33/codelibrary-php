...
/**
 * ProxyCreateTaxationItem Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyCreateTaxationItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyCreateTaxationItem';
    ...
    {
        $invalid_properties = [];
        if ($this->container['exempt_amount'] === null) {
            $invalid_properties[] = "'exempt_amount' can't be null";
        }
