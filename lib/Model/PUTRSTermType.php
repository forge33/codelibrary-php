...
/**
 * PUTRSTermType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTRSTermType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUTRSTermType';
    ...
    {
        $invalid_properties = [];
        if ($this->container['recognition_end'] === null) {
            $invalid_properties[] = "'recognition_end' can't be null";
        }
        if ($this->container['recognition_start'] === null) {
            $invalid_properties[] = "'recognition_start' can't be null";
        }
     ...
     * @param \DateTime $recognition_start The start date of a recognition period in `YYYY-MM-DD` format.  If there is a closed accounting period between the `recognitionStart` and `recognitionEnd` dates, the revenue that would be placed in the closed accounting period is instead placed in the next open accounting period.
     * @return $this
     */
