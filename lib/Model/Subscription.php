...
class Subscription implements ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'ancestor_account_id' => 'setAncestorAccountId',
    ...
    protected static $getters = [
        ...
        'ancestor_account_id' => 'getAncestorAccountId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ancestor_account_id'] = isset($data['ancestor_account_id']) ? $data['ancestor_account_id'] : null;
    ...
    /**
     * Gets ancestor_account_id
     * @return string
     */
    public function getAncestorAccountId()
    {
        return $this->container['ancestor_account_id'];
    }

    /**
     * Sets ancestor_account_id
     * @param string $ancestor_account_id A filter option for querying all subscriptions under the same account hierarchy. **Character limit**: 32 **Values**: [a valid account ID](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account)
     * @return $this
     */
    public function setAncestorAccountId($ancestor_account_id)
    {
        $this->container['ancestor_account_id'] = $ancestor_account_id;
