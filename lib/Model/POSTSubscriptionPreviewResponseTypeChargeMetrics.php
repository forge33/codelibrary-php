...
/**
 * POSTSubscriptionPreviewResponseTypeChargeMetrics Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTSubscriptionPreviewResponseTypeChargeMetrics implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTSubscriptionPreviewResponseType_chargeMetrics';
    ...
    protected static $setters = [
        ...
        'mrr' => 'setMrr',
        'number' => 'setNumber',
        'origin_rate_plan_id' => 'setOriginRatePlanId',
    ...
    protected static $getters = [
        ...
        'mrr' => 'getMrr',
        'number' => 'getNumber',
        'origin_rate_plan_id' => 'getOriginRatePlanId',
    ...
    {
        $this->container['dmrr'] = isset($data['dmrr']) ? $data['dmrr'] : null;
        $this->container['dtcv'] = isset($data['dtcv']) ? $data['dtcv'] : null;
        $this->container['mrr'] = isset($data['mrr']) ? $data['mrr'] : null;
        $this->container['number'] = isset($data['number']) ? $data['number'] : null;
        $this->container['origin_rate_plan_id'] = isset($data['origin_rate_plan_id']) ? $data['origin_rate_plan_id'] : null;
    ...
    {
        return $this->container['dmrr'];
    }

    /**
     * Sets dmrr
     * @param string $dmrr Change in monthly recurring revenue.
     * @return $this
     */
    public function setDmrr($dmrr)
    {
        $this->container['dmrr'] = $dmrr;
    ...
    /**
     * Sets dtcv
     * @param string $dtcv Change in total contract value.
     * @return $this
     */
    ...
    /**
     * Sets mrr
     * @param string $mrr Monthly recurring revenue.
     * @return $this
     */
    ...
    /**
     * Sets number
     * @param string $number The charge number of the subscription. Only available for update subscription.
     * @return $this
     */
    ...
    /**
     * Gets origin_rate_plan_id
     * @return string
     */
    public function getOriginRatePlanId()
    {
        return $this->container['origin_rate_plan_id'];
    }

    /**
     * Sets origin_rate_plan_id
     * @param string $origin_rate_plan_id The origin rate plan ID. Only available for update subscription.
     * @return $this
     */
    public function setOriginRatePlanId($origin_rate_plan_id)
    {
        $this->container['origin_rate_plan_id'] = $origin_rate_plan_id;
    ...
    /**
     * Sets original_id
     * @param string $original_id The original rate plan charge ID. Only available for update subscription.
     * @return $this
     */
     ...
     * @param string $product_rate_plan_charge_id The product rate plan charge ID.
     * @return $this
     */
     ...
     * @param string $product_rate_plan_id The product rate plan ID.
     * @return $this
     */
    ...
    /**
     * Sets tcv
     * @param string $tcv Total contract value.
     * @return $this
     */
