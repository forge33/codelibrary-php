...
/**
 * ProxyGetProductRatePlan Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyGetProductRatePlan implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyGetProductRatePlan';
    ...
    /**
     * Sets created_by_id
     * @param string $created_by_id The ID of the Zuora user who created the `ProductRatePlan` object. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets created_date
     * @param \DateTime $created_date The date when the `ProductRatePlan` object was created. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets description
     * @param string $description A description of the product rate plan. **Character limit**: 500 **Values**: a string of 500 characters or fewer
     * @return $this
     */
     ...
     * @param \DateTime $effective_end_date The date when the product rate plan expires and can't be subscribed to. **Character limit**: 29 **Values**: [a valid date and time value](/CB_Billing/WA_Dates_in_Zuora/A_Date_and_dateTime_Format)
     * @return $this
     */
     ...
     * @param \DateTime $effective_start_date The date when the product rate plan becomes available and can be subscribed to. **Character limit**: 29 **Values**: [a valid date and time value](/CB_Billing/WA_Dates_in_Zuora/A_Date_and_dateTime_Format)
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name The name of the product rate plan. The name doesn't have to be unique in a Product Catalog, but the name has to be unique within a product. **Character limit**: 100 **Values**: a string of 100 characters or fewer
     * @return $this
     */
    ...
    /**
     * Sets product_id
     * @param string $product_id The [ID of the product](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Product) that contains the product rate plan. **Character limit**: 32 **Values**: a string of 32 characters or fewer
     * @return $this
     */
