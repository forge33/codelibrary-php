...
/**
 * GETAccountTypeMetrics Class Doc Comment
 *
 * @category    Class */
 // @description Container for [account metrics](https://knowledgecenter.zuora.com/BC_Subscription_Management/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics).
/**
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache License v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountTypeMetrics implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountType_metrics';
    ...
    /**
     * Sets balance
     * @param string $balance The customer's total invoice balance minus credit balance.
     * @return $this
     */
    ...
    /**
     * Sets contracted_mrr
     * @param string $contracted_mrr Future expected MRR that accounts for future upgrades, downgrades, upsells and cancellations.
     * @return $this
     */
    ...
    /**
     * Sets credit_balance
     * @param string $credit_balance Current credit balance.
     * @return $this
     */
     ...
     * @param string $total_invoice_balance Total of all open invoices.
     * @return $this
     */
