...
/**
 * GETAccountTypeBillingAndPayment Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountTypeBillingAndPayment implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountType_billingAndPayment';
    ...
    /**
     * Sets currency
     * @param string $currency A currency defined in the [administrative web-based UI](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Customize_Currencies).
     * @return $this
     */
    ...
    /**
     * Sets payment_term
     * @param string $payment_term A payment-terms indicator defined in the [web-based UI administrative settings](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Payment_Terms), e.g., \"Net 30\".
     * @return $this
     */
