...
/**
 * PUTSubscriptionSuspendResponseType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTSubscriptionSuspendResponseType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUTSubscriptionSuspendResponseType';
    ...
    /**
     * Sets invoice_id
     * @param string $invoice_id Invoice ID, if an invoice is generated during the subscription process.
     * @return $this
     */
    ...
    /**
     * Sets resume_date
     * @param \DateTime $resume_date The date when subscription resumption takes effect, in the format yyyy-mm-dd.
     * @return $this
     */
    ...
    /**
     * Sets suspend_date
     * @param \DateTime $suspend_date The date when subscription suspension takes effect, in the format yyyy-mm-dd.
     * @return $this
     */
    ...
    /**
     * Sets term_end_date
     * @param \DateTime $term_end_date The date when the new subscription term ends, in the format yyyy-mm-dd.
     * @return $this
     */
