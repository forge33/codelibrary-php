...
/**
 * ProxyCreateUnitOfMeasure Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyCreateUnitOfMeasure implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyCreateUnitOfMeasure';
    ...
    {
        $invalid_properties = [];
        if ($this->container['uom_name'] === null) {
            $invalid_properties[] = "'uom_name' can't be null";
        }
