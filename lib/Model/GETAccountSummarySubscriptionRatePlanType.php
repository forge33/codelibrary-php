...
/**
 * GETAccountSummarySubscriptionRatePlanType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GETAccountSummarySubscriptionRatePlanType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GETAccountSummarySubscriptionRatePlanType';
     ...
     * @param string $product_rate_plan_id Product Rate Plan ID.
     * @return $this
     */
    ...
    /**
     * Sets product_sku
     * @param string $product_sku dummy
     * @return $this
     */
    ...
    /**
     * Sets rate_plan_name
     * @param string $rate_plan_name Rate plan name.
     * @return $this
     */
