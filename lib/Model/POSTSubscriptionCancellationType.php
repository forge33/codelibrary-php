...
/**
 * POSTSubscriptionCancellationType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTSubscriptionCancellationType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTSubscriptionCancellationType';
    ...
    protected static $setters = [
        ...
        'cancellation_effective_date' => 'setCancellationEffectiveDate',
    ...
    protected static $getters = [
        ...
        'cancellation_effective_date' => 'getCancellationEffectiveDate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cancellation_effective_date'] = isset($data['cancellation_effective_date']) ? $data['cancellation_effective_date'] : null;
    ...
    {
        $invalid_properties = [];
        if ($this->container['cancellation_policy'] === null) {
            $invalid_properties[] = "'cancellation_policy' can't be null";
        }
        if ($this->container['invoice_collect'] === null) {
            $invalid_properties[] = "'invoice_collect' can't be null";
        }
    ...
    /**
     * Gets cancellation_effective_date
     * @return \DateTime
     */
    public function getCancellationEffectiveDate()
    {
        return $this->container['cancellation_effective_date'];
    }

    /**
     * Sets cancellation_effective_date
     * @param \DateTime $cancellation_effective_date Date the cancellation takes effect, in the format yyyy-mm-dd.  Use only if `cancellationPolicy` is `SpecificDate`. Should not be earlier than the subscription contract-effective date, later than the subscription term-end date, or within a period for which the customer has been invoiced.
     * @return $this
     */
    public function setCancellationEffectiveDate($cancellation_effective_date)
    {
        $this->container['cancellation_effective_date'] = $cancellation_effective_date;
     ...
     * @param string $cancellation_policy Cancellation method. Possible values are: `EndOfCurrentTerm`, `EndOfLastInvoicePeriod`, `SpecificDate`. If using `SpecificDate`, the `cancellationEffectiveDate` field is required.
     * @return $this
     */
