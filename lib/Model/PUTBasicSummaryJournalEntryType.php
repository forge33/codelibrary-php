...
/**
 * PUTBasicSummaryJournalEntryType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PUTBasicSummaryJournalEntryType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PUT_BasicSummaryJournalEntryType';
    ...
    protected static $swaggerTypes = [
        ...
        'journal_entry_items' => '\Swagger\Client\Model\PUTJournalEntryItemType[]',
        'notes' => 'string',
     ...
     * @return \Swagger\Client\Model\PUTJournalEntryItemType[]
     */
     ...
     * @param \Swagger\Client\Model\PUTJournalEntryItemType[] $journal_entry_items Key name that represents the list of journal entry items.
     * @return $this
     */
