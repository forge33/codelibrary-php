...
/**
 * POSTSubscriptionPreviewTypePreviewAccountInfo Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class POSTSubscriptionPreviewTypePreviewAccountInfo implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'POSTSubscriptionPreviewType_previewAccountInfo';
    ...
    protected static $swaggerTypes = [
        'bill_cycle_day' => 'int',
        'bill_to_contact' => '\Swagger\Client\Model\POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact',
        'currency' => 'string',
    ...
    {
        $invalid_properties = [];
        if ($this->container['bill_cycle_day'] === null) {
            $invalid_properties[] = "'bill_cycle_day' can't be null";
        }
    ...
    /**
     * Sets bill_cycle_day
     * @param int $bill_cycle_day The account's bill cycle day (BCD), when bill runs generate invoices for the account. Specify any day of the month (`1`-`31`, where `31` = end-of-month), or `0` for auto-set.
     * @return $this
     */
     ...
     * @return \Swagger\Client\Model\POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact
     */
     ...
     * @param \Swagger\Client\Model\POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact $bill_to_contact
     * @return $this
     */
    ...
    /**
     * Sets currency
     * @param string $currency A currency as defined in (Billing Settings)[https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Customize_Currencies].
     * @return $this
     */
