...
/**
 * ProxyGetContact Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProxyGetContact implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProxyGetContact';
    ...
    /**
     * Sets created_by_id
     * @param string $created_by_id The ID of the Zuora user who created the contact. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets created_date
     * @param \DateTime $created_date The date when the contact was created. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets updated_by_id
     * @param string $updated_by_id The ID of the user who lasted updated the contact. **Character limit**: 32 **Values**: automatically generated
     * @return $this
     */
    ...
    /**
     * Sets updated_date
     * @param \DateTime $updated_date The date when the contact was last updated. **Character limit**: 29 **Values**: automatically generated
     * @return $this
     */
