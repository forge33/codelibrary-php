...
class ImportsApi
{
     ...
     */
    public function proxyDELETEImport($id)
    {
        list($response) = $this->proxyDELETEImportWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation proxyDELETEImportWithHttpInfo
     *
     * CRUD: Delete Import
     *
     * @param string $id Object id (required)
     ...
     */
    public function proxyDELETEImportWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyDELETEImport');
        }
        // parse inputs
        $resourcePath = "/object/import/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProxyGetImport
     */
    public function proxyGETImport($id, $fields = null)
    {
        list($response) = $this->proxyGETImportWithHttpInfo($id, $fields);
        return $response;
    }

    /**
     * Operation proxyGETImportWithHttpInfo
     *
     * CRUD: Retrieve Import
     *
     * @param string $id Object id (required)
     * @param string $fields Object fields to return (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProxyGetImport, HTTP status code, HTTP response headers (array of strings)
     */
    public function proxyGETImportWithHttpInfo($id, $fields = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyGETImport');
        }
        // parse inputs
        $resourcePath = "/object/import/{id}";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProxyGetImport',
                '/object/import/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProxyGetImport', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProxyGetImport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
    ...
    /**
     * Operation proxyPOSTImport
     *
     * CRUD: Create Import
     *
     * @param \Swagger\Client\Model\ProxyCreateImport $create_request  (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProxyCreateOrModifyResponse
     */
    public function proxyPOSTImport($create_request)
    {
        list($response) = $this->proxyPOSTImportWithHttpInfo($create_request);
        return $response;
    }

    /**
     * Operation proxyPOSTImportWithHttpInfo
     *
     * CRUD: Create Import
     *
     * @param \Swagger\Client\Model\ProxyCreateImport $create_request  (required)
     ...
     */
    public function proxyPOSTImportWithHttpInfo($create_request)
    {
        // verify the required parameter 'create_request' is set
        if ($create_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $create_request when calling proxyPOSTImport');
        }
        // parse inputs
        $resourcePath = "/object/import";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
