...
class ProductsApi
{
    ...
    /**
     * Operation proxyDELETEProductWithHttpInfo
     *
     * CRUD: Delete Product
     *
     * @param string $id Object id (required)
    ...
    public function proxyDELETEProductWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyDELETEProduct');
        }
        // parse inputs
    ...
    /**
     * Operation proxyGETProductWithHttpInfo
     *
     * CRUD: Retrieve Product
     *
     * @param string $id Object id (required)
    ...
    public function proxyGETProductWithHttpInfo($id, $fields = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProxyGetProduct',
                '/object/product/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProxyGetProduct', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProxyGetProduct', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
    ...
    /**
     * Operation proxyPOSTProduct
     *
     * CRUD: Create Product
     *
     * @param \Swagger\Client\Model\ProxyCreateProduct $create_request  (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
    ...
    /**
     * Operation proxyPOSTProductWithHttpInfo
     *
     * CRUD: Create Product
     *
     * @param \Swagger\Client\Model\ProxyCreateProduct $create_request  (required)
    ...
    public function proxyPOSTProductWithHttpInfo($create_request)
    {
        ...
        if ($create_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $create_request when calling proxyPOSTProduct');
        }
        // parse inputs
        $resourcePath = "/object/product";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation proxyPUTProduct
     *
     * CRUD: Update Product
     *
     * @param string $id Object id (required)
     * @param \Swagger\Client\Model\ProxyModifyProduct $modify_request  (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProxyCreateOrModifyResponse
     */
    ...
    /**
     * Operation proxyPUTProductWithHttpInfo
     *
     * CRUD: Update Product
     *
     * @param string $id Object id (required)
    ...
    public function proxyPUTProductWithHttpInfo($id, $modify_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyPUTProduct');
        }
        // verify the required parameter 'modify_request' is set
        if ($modify_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $modify_request when calling proxyPUTProduct');
        }
        // parse inputs
        $resourcePath = "/object/product/{id}";
        $httpBody = '';
