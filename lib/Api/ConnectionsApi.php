...
class ConnectionsApi
{
    ...
    /**
     * Operation pOSTConnections
     *
     * Establish connection to Zuora REST API service
     *
     * @param string $api_access_key_id Account username (required)
     * @param string $api_secret_access_key Account password (required)
     * @param string $content_type Must be set to \&quot;application/json\&quot; (required)
    ...
    /**
     * Operation pOSTConnectionsWithHttpInfo
     *
     * Establish connection to Zuora REST API service
     *
     * @param string $api_access_key_id Account username (required)
    ...
    public function pOSTConnectionsWithHttpInfo($api_access_key_id, $api_secret_access_key, $content_type)
    {
        ...
        if ($api_access_key_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_access_key_id when calling pOSTConnections');
        }
        // verify the required parameter 'api_secret_access_key' is set
        if ($api_secret_access_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_secret_access_key when calling pOSTConnections');
        }
        // verify the required parameter 'content_type' is set
        if ($content_type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $content_type when calling pOSTConnections');
        }
        // parse inputs
        ...
        // header params
        if ($api_access_key_id !== null) {
            $headerParams['apiAccessKeyId'] = $this->apiClient->getSerializer()->toHeaderValue($api_access_key_id);
        }
        // header params
        if ($api_secret_access_key !== null) {
            $headerParams['apiSecretAccessKey'] = $this->apiClient->getSerializer()->toHeaderValue($api_secret_access_key);
        }
        // header params
        if ($content_type !== null) {
