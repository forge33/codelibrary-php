...
class ExportsApi
{
     ...
     */
    public function proxyDELETEExport($id)
    {
        list($response) = $this->proxyDELETEExportWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation proxyDELETEExportWithHttpInfo
     *
     * CRUD: Delete Export
     *
     * @param string $id Object id (required)
     ...
     */
    public function proxyDELETEExportWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyDELETEExport');
        }
        // parse inputs
        $resourcePath = "/object/export/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProxyGetExport
     */
    public function proxyGETExport($id, $fields = null)
    {
        list($response) = $this->proxyGETExportWithHttpInfo($id, $fields);
        return $response;
    }

    /**
     * Operation proxyGETExportWithHttpInfo
     *
     * CRUD: Retrieve Export
     *
     * @param string $id Object id (required)
     * @param string $fields Object fields to return (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ProxyGetExport, HTTP status code, HTTP response headers (array of strings)
     */
    public function proxyGETExportWithHttpInfo($id, $fields = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyGETExport');
        }
        // parse inputs
        $resourcePath = "/object/export/{id}";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProxyGetExport',
                '/object/export/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProxyGetExport', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProxyGetExport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
    ...
    /**
     * Operation proxyPOSTExport
     *
     * CRUD: Create Export
     *
     * @param \Swagger\Client\Model\ProxyCreateExport $create_request  (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProxyCreateOrModifyResponse
     */
    public function proxyPOSTExport($create_request)
    {
        list($response) = $this->proxyPOSTExportWithHttpInfo($create_request);
        return $response;
    }

    /**
     * Operation proxyPOSTExportWithHttpInfo
     *
     * CRUD: Create Export
     *
     * @param \Swagger\Client\Model\ProxyCreateExport $create_request  (required)
     ...
     */
    public function proxyPOSTExportWithHttpInfo($create_request)
    {
        // verify the required parameter 'create_request' is set
        if ($create_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $create_request when calling proxyPOSTExport');
        }
        // parse inputs
        $resourcePath = "/object/export";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
